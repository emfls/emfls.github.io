...
def test_launch_manifest_is_exactly_the_current_launch_batch():
    ...
    if manifest["urls"] == ["/kor/column/yeongeogongbuhijoheunmideu/"]:
        assert manifest["contentPaths"] == ["kor/column/yeongeogongbuhijoheunmideu/index.html"]
    ...
    if manifest["urls"] == ["/kor/report/compare/taobao-forwarder-guide.html"]:
        ...
        assert manifest["remainingCapacity"] == 0
        return
    if manifest["urls"] == ["/kor/report/car/car-scrap-cost-guide.html"]:
        assert manifest["contentPaths"] == ["kor/report/car/car-scrap-cost-guide.html"]
