    ...
    def test_pages_give_a_current_first_answer(self):
        for relative_path in PAGES:
            with self.subTest(page=relative_path):
                ...
                expected_date = "2026-09-20" if relative_path == "kor/report/visa/ukraine.html" else ("2026-08-13" if relative_path in {"kor/report/camp/gapyeong.html", "kor/report/visa/uae.html", "kor/report/visa/russia.html"} else "2026-08-12")
