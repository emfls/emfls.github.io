    ...
    def test_page_contracts(self):
        for filename, (country, key_fact, official_url) in CASES.items():
            with self.subTest(filename=filename):
                ...
                expected_date = "2026-08-13" if filename in {"singapore.html", "uae.html", "philippines.html"} else "2026-08-12" if filename in {"russia.html", "saudiarabia.html"} else "2026-08-09"
