...
CASES = {
    "australia-newcastle.html": ("뉴캐슬", "https://visitnewcastle.com.au/"),
    "australia-adelaide.html": ("애들레이드", "https://southaustralia.com/"),
    "australia-perth.html": ("퍼스", "https://www.westernaustralia.com/"),
}

class PriorityAustraliaTravelPagesTest(unittest.TestCase):
    def test_page_contracts(self):
        for filename, (city, official_url) in CASES.items():
            with self.subTest(filename=filename):
                ...
                for phrase in ("한국 여권", "ETA", "공식", "최근 확인", "2026-08-09", official_url):
