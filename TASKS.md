...
- [ ] P0 Support — CI Baseline GA4 Contract 5건 복구
  ...
  - 검증: exact 5 tests 및 MarbleFlick/game hub 전용 테스트 통과; 전체 unittest 694 passed; 전체 pytest 1,006 passed; `git diff --check` 통과. 별도 CI-baseline PR과 GitHub SEO QA는 후속 확인한다.
