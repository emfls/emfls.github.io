...
- [ ] 10 · Russian 16-Type Personality Quiz — `/ru/game/MBTI/`
  - review branch only: 20 questions / 5 per axis, strict-majority scoring, root/RU axis-direction equivalence, independent Russian quiz identity, dedicated result profiles, privacy/ad-state correction, WebApplication-only schema, RU hub propagation, stale batch-test policy repair, and focused regression tests. Main merge, Pages deployment, Notion review, and 11번 작업은 후속 승인 이후 진행한다.
